...
- 生成的插槽目录中 `conversation.composer.dock` 占用者为 `client-ui-chat StatsPills id 'stats'` 与 `client-ui-subagent-tokens SubagentTokens id 'subagent-tokens'`。
