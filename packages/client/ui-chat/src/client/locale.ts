...
export const zh = {
  ...
  'stats.dialog.subagents': '子代理（{sessions}）',
  'stats.dialog.total': '合计（含子代理）',
  'stats.dialog.subagentInput': '子代理未缓存输入',
  'stats.dialog.subagentCacheRead': '子代理缓存读取',
  'stats.dialog.subagentCacheWrite': '子代理缓存写入',
  'stats.dialog.subagentOutput': '子代理输出',
...
export const en = {
  ...
  'stats.dialog.subagents': 'Subagents ({sessions})',
  'stats.dialog.total': 'Total incl. subagents',
  'stats.dialog.subagentInput': 'Subagent uncached input',
  'stats.dialog.subagentCacheRead': 'Subagent cached input',
  'stats.dialog.subagentCacheWrite': 'Subagent cache write',
  'stats.dialog.subagentOutput': 'Subagent output',
