// Subagent-inclusive token roll-up for the composer-dock stats pill.
//
...
export interface SubagentUsageTotals {
  ...
  /** Sum of the four buckets above: what the tree total adds to the own figure. */
  readonly tokens: number
}

/** No reachable descendant: the root's own figure is already the tree total. */
 ...
 * @param rootSessionId - Session whose totals are displayed; absent before a selection.
